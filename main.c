/*
Esse programa foi desenvolvido com o objetivo de permitir ao usuário a obtenção de dados de um arquivo de entrada (.csv) 
e gerar um arquivo binário com os mesmos,assim como realizar operações de busca, remoção e inserção de novos registros. 
Programa desenvolvido a partir de uma atividade proposta na disciplina de Organização de Arquivos (SCC0215) ministrada 
por Cristina Dutra de Aguiar.
